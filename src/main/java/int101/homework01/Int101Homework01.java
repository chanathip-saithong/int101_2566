...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
      ...
      */
      ...
      System.out.println("Work03:CalculateBMI: " + MyUtil.calculateBMI(50,150));
   ...
   static void work04UseOfObjectClass() {
      ...
      */
      ...
      person.setId(1111);
      System.out.println("Person's ID : " + person);

      Person person1 = new Person(1212);
      Person person2 = new Person(2222);

      BankAccount ac1 = new BankAccount(1, person1);
      BankAccount ac2 = new BankAccount(2, person2);

      ac1.deposit(5500.0);
      ac1.withdraw(1100.0);
      ac1.transfer(2400, ac2);

      System.out.println("Person 1's Account Balance: " + ac1.getBalance() + " ฿");
      System.out.println("Person 2's Account Balance: " + ac2.getBalance() + " ฿");
      person1.setId(2121);
      person2.setId(3121);
      System.out.println("Account 1: " + ac1);
      System.out.println("Account 2: " + ac2);
